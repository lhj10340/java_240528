...
public class ListSortEx01 {
	...
	public static void main(String[] args) {
		...
		/* Collections.sort(컬렉션, Comparator 객체)
		 ...
		 *  Comparator 인터페이스의 compare 추상 메소드를 오버라이딩 해야하고 오버라이딩한 코드에 따라 정렬 방식이 바뀐다.
		 * */
		Collections.sort(list, new Comparator<String>() {
			...
			public int compare(String o1, String o2) {
				...
				return -o1.compareTo(o2); // 앞에 - 붙이느냐 마느냐에 따라 오름차순 내림차순이 바뀐다.
			}
		...
		stds.add(new Student("2024160001", "고길동"));
		stds.add(new Student("2024160002", "홍길동"));
