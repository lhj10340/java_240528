...
public class ArrayEx05 {
	...
	public static void main(String[] args) {
		...
		// 숫자를 입력해서 입력한 숫자가 랜덤한 수에 있는지 확인하는 예지.
		...
		/* 방법1 ( 번지를 이용해야해서, 향상된 for문 이용이 불가. )
		 * 정수 3개가 있는데, 내가 찾으려는 정수의 위치가 어딘지 확인.
		 * 중간에 찾았으면 1 ~ 3 사이에 위치하고, 없으면 3보다 크다.
		 * => 중간에 찾았으면 0 ~ 2번지 사이에 있고, 없다면 번지가 3이다.
		 * 
		 ...
		 * 반복문 종료 후 : result가 true 이면 ~은 있습니다.라고 출력하고 아니면 ~은 없습니다. 라고 출력.
		 * */
