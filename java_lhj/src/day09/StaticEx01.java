...
public class StaticEx01 {
	...
	public static void main(String[] args) {
		...
		// 학생1과 학생2의 정보를 출력하는 코드르 작성(print)
		std1.print();
		std2.print();
		// 학생1과 학생 2의 고등학교를 출력하는 코드를 작성(printSchoolName)
