...
public class StringEx01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Hello world 에서 o 를 찾아서 O로 수정 : " + str.replace("o", "O"));
		System.out.println("수정한 후, str : " + str);
		
		// String substring (시작번지) : 시작 번지부터 부분 문자열을 추출
		// String substring (시작번지, 끝번지) : 시작 번지부터 끝번지 전까지 부분 문자열을 추출 (끝번지 미포함)
		...
		String str4 = String.valueOf(1); // String4 = "" + 1;
