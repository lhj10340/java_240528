...
public class FileUploadUtils {
	...
	//=> 한 폴더에 첨부파일을 모두 업로드하면 서버의 성능이 떨어지기 때문에 파일을 분산시키기 위해 폴더를 생성
	// ... 은 가변 매개변수 ( 매개변수의 갯수가 정해져있지 않을 때 )
	public static void makeDir(String uploadPath, String ... paths) {
		// 2024, 2024/08, 2024/08/19
		int lastIndex = paths.length - 1;
		// 마지막 폴더(2024/08/19)가 존재한다면, 이전 폴더(2024, 2024/08)를 만들 필요가 없다.
