...
function ButtonBox3(){
	...
	return(
		<form>
			...
			<Button text={"전송"} type={"submit"} classNames={"btn br-5"}></Button>
			<Button text={"버튼"} type={"button"} classNames={"btn"} style={style}></Button>
			<Button text={"리셋"} type={"reset"} classNames={"btn"}></Button>
		</form>
	)
}
