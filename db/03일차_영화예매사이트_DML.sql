...
# 관리자가 아이디 admin1, 비번 admin1로 회원가입을 진행했을 떄, 사용하는 쿼리
...
insert into person values
    (NULL, '라이언 레이놀즈','1976-10-23','<엑스맨 탄생: 울버린> 등 ...','캐나다'),
...
# 7. 캐릭터를 등록 : 데드풀과 울버린에 나오는 역할을 등록. 사진은 NULL.
...
# 강남 cgv 를 등록. 상영관 : 3, 좌석 30
INSERT INTO THEATER VALUE (NULL, 'CGV강남', 3, 30, '서울특별시 강남구 강남대로 438 (역삼동) 스타플렉스', '서울');
...
# 영등포 cgv 를 등록. 상영관 : 4, 좌석 44
INSERT INTO THEATER VALUE 
(NULL, '영등포 CGV', 4, 44, '서울특별시 영등포구 영중로 15 경방 타임스퀘어 4~7층', '영등포구');
...
# 1관 - 10:10(조조), 12:35, 15:10, 17:45, 20:20
...
# 성인 14,000원 / 청소년 10,000원 / 조조 : 성인 12,000 / 청소년 8,000원
...
# abc123 회원이 CGV강남 1관에서 처음에 상영하는 데드풀과 울버린 성인 2장을 예매하는 쿼리

insert into ticketing values
(null, 2, 0, 24000, 'abc123', 1);

insert into ticketing_list values(null, 1, 1), (null, 2, 1);