...
<body>
	...
	<h1>게시글 수정</h1>
		...
		<form action="<c:url value="/post/update"/>" method="post" enctype="multipart/form-data">
			...
			<div class="form-group file-container">
				...
				<c:forEach items="${list}" var="file">
					<div class="form-control" style="postion: relative;">
		...
		$('.btn-del').click(function(){
			...
			$(this).parent().remove();
			var input = `<input type="text" name="fi_nums" value="\${fi_num}">`
			var file = `<input type="file" class="form-control" id="title" name="fileList">`;
