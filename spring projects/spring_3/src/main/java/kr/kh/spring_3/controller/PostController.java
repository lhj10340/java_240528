...
import kr.kh.spring_3.model.vo.FileVO;
...
public class PostController {
	...
	public String delete(Model model, @PathVariable("co_num")int co_num , @PathVariable("po_num")int po_num, PostVO post, HttpSession session) {
